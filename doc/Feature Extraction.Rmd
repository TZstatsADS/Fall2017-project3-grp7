...
files<- list()
img_dir<- "~/Desktop/Fall2107-Proj3-Grp7/data/training_set/images/"
...
#saveRDS(RGB_features, "../Desktop/Fall2107-Proj3-Grp7/rgb_feature2.RData")
```


```{r}
label_train<- read.csv("../Desktop/Fall2107-Proj3-Grp7/data/training_set/label_train.csv")[, 2]
names(label_train)<-"y"
...
write.csv(training, file = "../Desktop/Fall2107-Proj3-Grp7/output/rgb_training2.csv", row.names = FALSE)
write.csv(testing, file = "../Desktop/Fall2107-Proj3-Grp7/output/rgb_testing2.csv", row.names = FALSE)
write.csv(RGB_features, file="../Desktop/Fall2107-Proj3-Grp7/output/rgb_feature2.csv", row.names = FALSE)
```
